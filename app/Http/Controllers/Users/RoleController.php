...
class RoleController extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		$url = ['route' => 'users.roles', 'item_name' => 'role', 'query' => $request->query()];
		$query = $request->query();

        return view('users.roles.list', compact('items', 'columns', 'rows', 'actions', 'filters', 'url', 'query'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('users.roles.form', compact('fields', 'actions', 'board', 'query', 'permissions'));
    }
    ...
    public function edit(Request $request, $id)
    {
		...
		if (!$role->canAccess()) {
			return redirect()->route('users.roles.index', $request->query())->with('error',  __('messages.generic.access_not_auth'));
		}

		if ($role->checked_out && $role->checked_out != auth()->user()->id) {
			return redirect()->route('users.roles.index', $request->query())->with('error',  __('messages.generic.checked_out'));
		}
        ...
        return view('users.roles.form', compact('role', 'fields', 'actions', 'board', 'query'));
    }
    ...
    public function cancel(Request $request, Role $role = null)
    {
		...
		return redirect()->route('users.roles.index', $request->query());
    }
