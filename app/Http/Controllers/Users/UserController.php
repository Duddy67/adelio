...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = $request->query();
        $url = ['route' => 'users.users', 'item_name' => 'user', 'query' => $query];
        
        return view('users.users.list', compact('items', 'columns', 'rows', 'actions', 'filters', 'url', 'query'));
    }
