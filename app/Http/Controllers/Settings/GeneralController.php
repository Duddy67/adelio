...
class GeneralController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('settings.general');
    ...
    public function index(Request $request)
    {
        ...
        return view('settings.general.form', compact('fields', 'actions', 'data', 'query'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('settings.general.index', $request->query())->with('success', __('messages.general.update_success'));
    }
