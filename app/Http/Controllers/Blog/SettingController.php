...
class SettingController extends Controller
{
    ...
    public function index(Request $request, $tab = null)
    {
        ...
        return view('blog.settings.form', compact('fields', 'actions', 'data', 'tab', 'query'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('blog.settings.index', array_merge($request->query(), ['tab' => $request->input('_tab')]))->with('success', __('messages.general.update_success'));
    }
